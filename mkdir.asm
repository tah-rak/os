...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    3033:	ff 33                	push   (%ebx)
    3035:	e8 01 03 00 00       	call   333b <mkdir>
  ...
  exit();
    ...
    3050:	50                   	push   %eax
    3051:	ff 33                	push   (%ebx)
    3053:	68 6f 37 00 00       	push   $0x376f
    3058:	6a 02                	push   $0x2
    ...
    338c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    33b9:	0f b6 92 ec 37 00 00 	movzbl 0x37ec(%edx),%edx
    ...
    3439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    34a9:	ff 24 85 94 37 00 00 	jmp    *0x3794(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    35b7:	90                   	nop
          s = "(null)";
    35b8:	ba 8b 37 00 00       	mov    $0x378b,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    35d1:	a1 a4 3a 00 00       	mov    0x3aa4,%eax
{
  ...
  freep = p;
    ...
    3611:	5b                   	pop    %ebx
  freep = p;
    3612:	89 15 a4 3a 00 00    	mov    %edx,0x3aa4
}
    3618:	5e                   	pop    %esi
    3619:	5f                   	pop    %edi
    361a:	5d                   	pop    %ebp
  ...
  freep = p;
    364c:	89 15 a4 3a 00 00    	mov    %edx,0x3aa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    366c:	8b 3d a4 3a 00 00    	mov    0x3aa4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    36b1:	8b 3d a4 3a 00 00    	mov    0x3aa4,%edi
  ...
  return freep;
    36df:	8b 15 a4 3a 00 00    	mov    0x3aa4,%edx
    ...
    370c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    370f:	89 15 a4 3a 00 00    	mov    %edx,0x3aa4
}
    ...
    371f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3720:	c7 05 a4 3a 00 00 a8 	movl   $0x3aa8,0x3aa4
    3727:	3a 00 00 
    base.s.size = 0;
    372a:	bf a8 3a 00 00       	mov    $0x3aa8,%edi
    base.s.ptr = freep = prevp = &base;
    372f:	c7 05 a8 3a 00 00 a8 	movl   $0x3aa8,0x3aa8
    3736:	3a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    373b:	c7 05 ac 3a 00 00 00 	movl   $0x0,0x3aac
    3742:	00 00 00 
    if(p->s.size >= nunits){
